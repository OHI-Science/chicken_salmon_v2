...
I think I can remove everything past this line
...
#                          country_farm_feed_chi/eez_area_km2*1000000000,
  ...
  ### CDK: Happy to discuss - we currently sum them within Country (group_by argument above) if that makes more sense with what you mean by "within a location"? I looked through the updated_results script and I don't think this variable is used in the results anyways.
...
***CDK: In the results script, I combine land and EEZ area to recalculate this across both so I think it is OK in the text. Could potentially remove here to avoid confusion.
- updated_results_march_2022.Rmd
- line 50: mutate(avg_cum_stress_km2= country_farm_feed_chi/(eez_area_km2 + land_area_km2))
...
758973.1/505014  ##cumulative divided by number of cells
1.502875 # same as taking mean

758973.1/(505014*36)  ## cumulative divided by area
0.04174654 ## cumualative per km2 from raster area
