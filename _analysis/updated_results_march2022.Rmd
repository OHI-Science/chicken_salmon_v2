...
```{r}
cor.test(broiler_cpi_km2_prod$avg_cum_stress_km2, broiler_cpi_km2_prod$total_area, type = "pearsons")
```

```{r}
cor.test(salmon_cpi_km2_prod$avg_cum_stress_km2, salmon_cpi_km2_prod$total_area, type = "pearsons")
```
