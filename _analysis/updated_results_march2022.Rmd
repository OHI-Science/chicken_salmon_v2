...
Ask Mel if a similar file to this exists??
```{r}
...
```{r}
#broilers <- list.files("/home/shares/food-systems/Food_footprint/stressor_summary/equal_area/#system_stressor", pattern="chicken", full=TRUE)
