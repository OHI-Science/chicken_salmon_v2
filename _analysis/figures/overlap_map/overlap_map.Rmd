...
legend_graph
ggsave(here("_analysis/overlap_map/outputs/overlap_legend.jpg"), width=5, height=3, dpi=300)
...
ggsave(here("_analysis/figures/overlap_map/outputs/overlap_circle_legend.jpg"), width=6, height=4, dpi=300,  bg = "white") 
```
